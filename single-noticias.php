...
<div id="contenido-post">
  ...
  <!--Contenido del post-->
    <div class="col-12 col-sm-12 col-md-9">
      <h1 align="center" class="titulo-principal"><?php echo $titulo; ?></h1>
    ...
    <div class="col-12 col-sm-12 col-md-3" align="center">
      ...
      <?php $the_query = new WP_Query( array( 'post_type' => 'video', 'posts_per_page' => 3 ) );?>
      ...
      <?php while ( $the_query->have_posts() ) : $the_query->the_post();?>
        ...
        <div class="col-md-12 col-sm-12 col-lg-12 bordes-estilos-youtube-videos">
          <div class="estilo-youtube-videos" style="background-image:url(' <?php the_post_thumbnail_url(); ?>');" ></div>
